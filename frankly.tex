...
\inferrule
  {(\hasgs{U_i}{t_i})_i \\
   k~\many{U} \in D~\many{V}}
  {\hasgs{D~\many{V}}{k~\many{t}}}
...
\inferrule
  {\makesgs{s}{D~\many{V}} \\
   (\does{\Gamma, \many{x_k}:\many{U}}{\sigs}{C}{e_k})_{k~\many{U} \in D~\many{V}}}
...
\inferrule
  {\sigs' \text{ closed} \\
   ...
   (\does{\Gamma, \many{x_c}:\many{U}, g_c:\effbox{\sigs~\sigs'}\thunk{U' \to F~V}}
