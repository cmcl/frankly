...
R &::= \template{+\op\,\Us}{}{\V}, R \mid -\op, R \mid \cdot \\
\end{array}
\]
...
\inferrule
  {\doesgs{\h}{\handleType{S}{\sig'}{\U} \to \C} \\
   \has{\Gamma}{\sig'}{\U}{\tm} \\
   \Gamma \vdash S \leq \sig' \leq \sig \rplus S
  }
  {\doesgs{\handle{\h}{\tm}}{\C}}
\\
\inferrule
...
\inferrule
  {\doesgs{\tm}{\forall \varepsilon~\keyword{where}~R.\V} \\
   \Gamma \vdash S \judgeword{satisfies} R}
  {\doesgs{\tm~S}{\V[S/\varepsilon]}}
\end{mathpar}
...
\inferrule
  {\template{\op\,\Us}{}{\U} \in S \\
   [\pat{\U_i}{\p_i}{\Gamma_i}] \\
   \pat{\thunk{\U \to \ret{\sig'}{\V}}}{k}{\Gamma}}
