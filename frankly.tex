...
\sigs &::=
  \emptyset \mid \alpha \mid \sigs, \sig~\many{V} \\
\psigs &::=
  \emptyset \mid \beta \mid \psigs, \sig~\many{V} \\
\\
\Gamma &::= \cdot \mid \Gamma, x:V \mid \Gamma, m:Q \mid \Gamma, g:C \\
\end{array}
\]
...
\sigs~\beta &= \sigs \\
\sigs~(\psigs, \sig~\many{V}) &= (\sigs~\psigs), \sig~\many{V} \\
\end{array}
\]
...
\inferrule
  {\cangs{f}{\effbox{\sigs}V(\many{\effbox{\psigs}V})} \\
   \has{\Gamma}{\sigs~\psigs_i}{V_i}{t_i}}
  {\makesgs{f~\many{t}}{V}}
\end{mathpar}
...
\inferrule
  {\dom(\theta) = \FV(C) \backslash (\FV(\Gamma) \cup \FV(\sigs)) \\
   \theta(\alpha) = \sigs \\
   \theta(C) = \effbox{\sigs}V(\many{Q})}
  {\can{\Gamma, g:C}{\sigs}{g}{\effbox{\sigs}V(\many{Q})}}

\inferrule
  {c : V'(\many{V}) \in \sigs}
  {\cangs{c}{\effbox{\sigs}V'(\many{\effbox{\beta}V})}}
...
\inferrule
  {\has{\Gamma, \many{m}:\many{Q}}{\sigs'}{V}{t}}
  {\hasgs{\thunk{\effbox{\sigs'}V(\many{Q})}}{\thunk{\many{m} \to t}}}
...
\inferrule
  {(\has{\Gamma, \many{x_c}:\many{V}, g:\effbox{\sigs~\psigs}U(\effbox{\beta}V')}
       {\sigs}{W}{t_c})_{c : V'(\many{V}) \in \psigs} \\
   \has{\Gamma, x:U}{\sigs}{W}{t}}
  {\has{\Gamma, m:\effbox{\sigs~\psigs}V}{\sigs}
