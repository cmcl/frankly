...
\\
\VV &::= \alpha \mid \thunk{\CC} \mid \D~\VVs \mid \handleType{S}{\Sigma}{\VV} \\
...
\insts{\alpha}      &= \alpha',  &\alpha' \text{ a fresh unification variable} \\
\insts{\thunk{\CC}} &= \thunk{\insts{\CC}} \\
\insts{\D~\VVs}     &= \D~\insts{\VVs} \\
\insts{\handleType{S'}{S-S'}{\VV}} 
                    &= \handleType{S'}{S-S'}{\insts{\VV}} \\
\insts{\handleType{S'}{R}{\VV}} 
                    &= \handleType{S'}{S-S'}{\insts{\VV}},
                         &\sigentails{S-S'} R \\
\\
\insts{\ret{S}{\VV}} &= \ret{S}{\VV} \\
\insts{\ret{R}{\VV}} &= \ret{S}{\VV},  &\sigentails{S} R \\
\insts{\VV \to \CC}  &= \insts{\VV} \to \insts{\CC} \\
\end{array}
\]
